...
***Figure 1:** Total library sizes grouped by Cell Line, Treatment, and Genetic perturbation.*
...
***Figure-3:** Pearson correlation of log2-transformed counts for replicates per group*
...
***Figure-4:*** Top 3 Highly Expressed Genes per sample
...
***Figure-5:*** Library Composition by Gene Category. All genes are classified into three broad categories- Mitochondrial, Ribosomal and Nuclear/other.

PC3 samples have a significantly higher mitochondrial burden (\~45%) compared to LNCaP. This could be result of a different metabolic profile or due to technical reasons such as higher cell death.
